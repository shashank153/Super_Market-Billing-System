...
public class VIEW_BILL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/familymart_new/search-icon (1).png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/familymart_new/home-icon.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         try
        {
            ...
            String Selectquery="Select * from bill where MO_NO ='"+ jTextField1.getText()+"'";            
        ...
        {
            JOptionPane.showMessageDialog(null,"No BILL Found!!");
        }      
